...
export default function EditSession() {
  ...
  useEffect(() => {
    async function load() {
      ...
      setForm({
        ...
        waves: data.waves,
        notes: data.notes,
        swell_height: data.swell_height ?? null,
        swell_period: data.swell_period ?? null,
        swell_direction: data.swell_direction ?? null,
  ...
  useEffect(() => {
    ...
    if (form.swell_height != null && form.water_temp_c != null) return
    ...
    fetchSwellData(loc.latitude, loc.longitude, form.date)
      ...
      .catch(() => { if (!cancelled) setSwellError('Could not fetch swell data.') })
